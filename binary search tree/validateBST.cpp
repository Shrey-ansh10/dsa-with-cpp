...
public:
    ...
    bool validateBinTree(TreeNode* root, long long min, long long max){
        ...
        // if we don't stuck in base case - recursive calls on left and right sub tree
    ...
    bool isValidBST(TreeNode* root) {
        ...
        // So that means we can use Long long in our solution, but before that there is someone's responsibility to check if the value at each node is in that range. 
